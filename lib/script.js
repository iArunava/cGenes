...
$(document).ready(() => {
    ...
    cslider = document.getElementById('id--slider-crossover');
    mslider = document.getElementById('id--slider-mutation');

    psize = pslider.value;
    cval = cslider.value / 100;
    mval = mslider.value / 100;
    console.log(psize, cval, mval);
...
let step = () => {
    ...
    next_pops = crossover(selected_genes, psize, cval, GSIZE);
    console.log(next_pops);
